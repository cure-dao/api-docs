...
export function StudyTextFromJSON(json: any): StudyText {
    return StudyTextFromJSONTyped(json, false);
}

export function StudyTextFromJSONTyped(json: any, ignoreDiscriminator: boolean): StudyText {
    if ((json === undefined) || (json === null)) {
        return json;
    }
    return {
        
        'averageEffectFollowingHighCauseExplanation': !exists(json, 'averageEffectFollowingHighCauseExplanation') ? undefined : json['averageEffectFollowingHighCauseExplanation'],
        'averageEffectFollowingLowCauseExplanation': !exists(json, 'averageEffectFollowingLowCauseExplanation') ? undefined : json['averageEffectFollowingLowCauseExplanation'],
        'valuePredictingHighOutcomeExplanation': !exists(json, 'valuePredictingHighOutcomeExplanation') ? undefined : json['valuePredictingHighOutcomeExplanation'],
        'valuePredictingLowOutcomeExplanation': !exists(json, 'valuePredictingLowOutcomeExplanation') ? undefined : json['valuePredictingLowOutcomeExplanation'],
        'dataAnalysis': !exists(json, 'dataAnalysis') ? undefined : json['dataAnalysis'],
        'dataSources': !exists(json, 'dataSources') ? undefined : json['dataSources'],
        'dataSourcesParagraphForCause': !exists(json, 'dataSourcesParagraphForCause') ? undefined : json['dataSourcesParagraphForCause'],
        'dataSourcesParagraphForEffect': !exists(json, 'dataSourcesParagraphForEffect') ? undefined : json['dataSourcesParagraphForEffect'],
        'lastCauseDailyValueSentenceExtended': !exists(json, 'lastCauseDailyValueSentenceExtended') ? undefined : json['lastCauseDailyValueSentenceExtended'],
        'lastCauseAndOptimalValueSentence': !exists(json, 'lastCauseAndOptimalValueSentence') ? undefined : json['lastCauseAndOptimalValueSentence'],
        'lastCauseDailyValueSentence': !exists(json, 'lastCauseDailyValueSentence') ? undefined : json['lastCauseDailyValueSentence'],
        'optimalDailyValueSentence': !exists(json, 'optimalDailyValueSentence') ? undefined : json['optimalDailyValueSentence'],
        'participantInstructions': !exists(json, 'participantInstructions') ? undefined : json['participantInstructions'],
        'predictorExplanation': !exists(json, 'predictorExplanation') ? undefined : json['predictorExplanation'],
        'significanceExplanation': !exists(json, 'significanceExplanation') ? undefined : json['significanceExplanation'],
        ...
        'studyInvitation': !exists(json, 'studyInvitation') ? undefined : json['studyInvitation'],
        'studyQuestion': !exists(json, 'studyQuestion') ? undefined : json['studyQuestion'],
        'studyBackground': !exists(json, 'studyBackground') ? undefined : json['studyBackground'],
    };
}

export function StudyTextToJSON(value?: StudyText | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
