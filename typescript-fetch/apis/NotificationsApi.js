...
var NotificationsApi = /** @class */ (function (_super) {
     ...
     * Get NotificationPreferences
     */
    NotificationsApi.prototype.getNotificationPreferencesRaw = function () {
     ...
     * Get NotificationPreferences
     */
    NotificationsApi.prototype.getNotificationPreferences = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.getNotificationPreferencesRaw()];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
     ...
     * Post DeviceTokens
     */
    NotificationsApi.prototype.postDeviceTokenRaw = function (requestParameters) {
        return __awaiter(this, void 0, void 0, function () {
            var queryParameters, headerParameters, response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.request({
                                ...
                                headers: headerParameters,
                                query: queryParameters,
                                body: (0, models_1.DeviceTokenToJSON)(requestParameters.body),
                            })];
                    case 1:
                        response = _a.sent();
                        return [2 /*return*/, new runtime.VoidApiResponse(response)];
     ...
     * Post DeviceTokens
     */
    NotificationsApi.prototype.postDeviceToken = function (requestParameters) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.postDeviceTokenRaw(requestParameters)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
