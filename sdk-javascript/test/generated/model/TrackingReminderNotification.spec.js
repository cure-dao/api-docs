...
var instance;
beforeEach(function(){
    instance = new CureDAO.TrackingReminderNotification();
});
describe('TrackingReminderNotification', function(){
    it('should create an instance of TrackingReminderNotification', function(){
        ...
        //var instance = new CureDAO.TrackingReminderNotification();
        //expect(instance).to.be.a(CureDAO.TrackingReminderNotification);
    });
    ...
    it('should have the property trackingReminderNotificationId (base name: "trackingReminderNotificationId")',
        function(){
            // uncomment below and update the code to test the property trackingReminderNotificationId
            //var instance = new CureDAO.TrackingReminderNotification();
            //expect(instance).to.be();
        });
    it('should have the property trackingReminderNotificationTime (base name: "trackingReminderNotificationTime")',
        function(){
            // uncomment below and update the code to test the property trackingReminderNotificationTime
            //var instance = new CureDAO.TrackingReminderNotification();
            //expect(instance).to.be();
        });
    it('should have the property trackingReminderNotificationTimeEpoch (base name: "trackingReminderNotificationTimeEpoch")',
        function(){
            // uncomment below and update the code to test the property trackingReminderNotificationTimeEpoch
            //var instance = new CureDAO.TrackingReminderNotification();
            //expect(instance).to.be();
        });
    it('should have the property trackingReminderNotificationTimeLocal (base name: "trackingReminderNotificationTimeLocal")',
        function(){
            // uncomment below and update the code to test the property trackingReminderNotificationTimeLocal
            //var instance = new CureDAO.TrackingReminderNotification();
            //expect(instance).to.be();
        });
    it('should have the property trackingReminderNotificationTimeLocalHumanString (base name: "trackingReminderNotificationTimeLocalHumanString")',
        function(){
