...
var instance;
beforeEach(function(){
    instance = new CureDAO.StudySharing();
});
describe('StudySharing', function(){
    it('should create an instance of StudySharing', function(){
        // uncomment below and update the code to test StudySharing
        //var instance = new CureDAO.StudySharing();
        //expect(instance).to.be.a(CureDAO.StudySharing);
    });
