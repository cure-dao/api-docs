...
var instance;
beforeEach(function(){
    instance = new CureDAO.StudyCharts();
});
describe('StudyCharts', function(){
    it('should create an instance of StudyCharts', function(){
        ...
        //var instance = new CureDAO.StudyCharts();
        //expect(instance).to.be.a(CureDAO.StudyCharts);
    });
    ...
    it('should have the property outcomeDistributionColumnChart (base name: "outcomeDistributionColumnChart")',
        function(){
            // uncomment below and update the code to test the property outcomeDistributionColumnChart
            //var instance = new CureDAO.StudyCharts();
            //expect(instance).to.be();
        });
    it('should have the property predictorDistributionColumnChart (base name: "predictorDistributionColumnChart")',
        function(){
