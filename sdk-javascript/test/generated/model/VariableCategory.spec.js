...
var instance;
beforeEach(function(){
    instance = new CureDAO.VariableCategory();
});
describe('VariableCategory', function(){
    it('should create an instance of VariableCategory', function(){
        ...
        //var instance = new CureDAO.VariableCategory();
        //expect(instance).to.be.a(CureDAO.VariableCategory);
    });
    ...
    it('should have the property measurementSynonymSingularLowercase (base name: "measurementSynonymSingularLowercase")',
        function(){
