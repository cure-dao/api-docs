...
var instance;
beforeEach(function(){
    instance = new CureDAO.TrackingReminderNotificationPost();
});
describe('TrackingReminderNotificationPost', function(){
    it('should create an instance of TrackingReminderNotificationPost', function(){
        ...
        //var instance = new CureDAO.TrackingReminderNotificationPost();
        //expect(instance).to.be.a(CureDAO.TrackingReminderNotificationPost);
    });
