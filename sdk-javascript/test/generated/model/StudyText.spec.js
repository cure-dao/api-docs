...
var instance;
beforeEach(function(){
    instance = new CureDAO.StudyText();
});
describe('StudyText', function(){
    it('should create an instance of StudyText', function(){
        ...
        //var instance = new CureDAO.StudyText();
        //expect(instance).to.be.a(CureDAO.StudyText);
    });
    it('should have the property averageEffectFollowingHighCauseExplanation (base name: "averageEffectFollowingHighCauseExplanation")',
        function(){
            // uncomment below and update the code to test the property averageEffectFollowingHighCauseExplanation
            //var instance = new CureDAO.StudyText();
            //expect(instance).to.be();
        });
    it('should have the property averageEffectFollowingLowCauseExplanation (base name: "averageEffectFollowingLowCauseExplanation")',
        function(){
            // uncomment below and update the code to test the property averageEffectFollowingLowCauseExplanation
            //var instance = new CureDAO.StudyText();
            //expect(instance).to.be();
        });
    it('should have the property valuePredictingHighOutcomeExplanation (base name: "valuePredictingHighOutcomeExplanation")',
        function(){
            // uncomment below and update the code to test the property valuePredictingHighOutcomeExplanation
            //var instance = new CureDAO.StudyText();
            //expect(instance).to.be();
        });
    it('should have the property valuePredictingLowOutcomeExplanation (base name: "valuePredictingLowOutcomeExplanation")',
        function(){
    ...
    it('should have the property dataSourcesParagraphForEffect (base name: "dataSourcesParagraphForEffect")',
        function(){
            // uncomment below and update the code to test the property dataSourcesParagraphForEffect
            //var instance = new CureDAO.StudyText();
            //expect(instance).to.be();
        });
    it('should have the property lastCauseDailyValueSentenceExtended (base name: "lastCauseDailyValueSentenceExtended")',
        function(){
            // uncomment below and update the code to test the property lastCauseDailyValueSentenceExtended
            //var instance = new CureDAO.StudyText();
            //expect(instance).to.be();
        });
    it('should have the property lastCauseAndOptimalValueSentence (base name: "lastCauseAndOptimalValueSentence")',
        function(){
