...
var instance;
beforeEach(function(){
    instance = new CureDAO.TrackingReminder();
});
describe('TrackingReminder', function(){
    it('should create an instance of TrackingReminder', function(){
        ...
        //var instance = new CureDAO.TrackingReminder();
        //expect(instance).to.be.a(CureDAO.TrackingReminder);
    });
    ...
    it('should have the property frequencyTextDescriptionWithTime (base name: "frequencyTextDescriptionWithTime")',
        function(){
    ...
    it('should have the property latestTrackingReminderNotificationReminderTime (base name: "latestTrackingReminderNotificationReminderTime")',
        function(){
            // uncomment below and update the code to test the property latestTrackingReminderNotificationReminderTime
            //var instance = new CureDAO.TrackingReminder();
            //expect(instance).to.be();
        });
    it('should have the property localDailyReminderNotificationTimes (base name: "localDailyReminderNotificationTimes")',
        function(){
            // uncomment below and update the code to test the property localDailyReminderNotificationTimes
            //var instance = new CureDAO.TrackingReminder();
            //expect(instance).to.be();
        });
    it('should have the property localDailyReminderNotificationTimesForAllReminders (base name: "localDailyReminderNotificationTimesForAllReminders")',
        function(){
            // uncomment below and update the code to test the property
            // localDailyReminderNotificationTimesForAllReminders var instance = new CureDAO.TrackingReminder();
            // expect(instance).to.be();
        });
    ...
    it('should have the property reminderStartTimeLocalHumanFormatted (base name: "reminderStartTimeLocalHumanFormatted")',
        function(){
    ...
    it('should have the property userVariableUnitAbbreviatedName (base name: "userVariableUnitAbbreviatedName")',
        function(){
    ...
    it('should have the property userVariableVariableCategoryId (base name: "userVariableVariableCategoryId")',
        function(){
            // uncomment below and update the code to test the property userVariableVariableCategoryId
            //var instance = new CureDAO.TrackingReminder();
            //expect(instance).to.be();
        });
    it('should have the property userVariableVariableCategoryName (base name: "userVariableVariableCategoryName")',
        function(){
    ...
    it('should have the property valueAndFrequencyTextDescription (base name: "valueAndFrequencyTextDescription")',
        function(){
            // uncomment below and update the code to test the property valueAndFrequencyTextDescription
            //var instance = new CureDAO.TrackingReminder();
            //expect(instance).to.be();
        });
    it('should have the property valueAndFrequencyTextDescriptionWithTime (base name: "valueAndFrequencyTextDescriptionWithTime")',
        function(){
