...
var instance;
beforeEach(function(){
    instance = new CureDAO.FeedResponse();
});
describe('FeedResponse', function(){
    it('should create an instance of FeedResponse', function(){
        // uncomment below and update the code to test FeedResponse
        //var instance = new CureDAO.FeedResponse();
        //expect(instance).to.be.a(CureDAO.FeedResponse);
    });
