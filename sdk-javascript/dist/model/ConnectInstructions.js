 ...
 * @version 0.0.1
 */
var ConnectInstructions = /*#__PURE__*/function () {
  /**
   ...
   */
  function ConnectInstructions(url) {
    _classCallCheck(this, ConnectInstructions);
  ...
  _createClass(ConnectInstructions, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('usePopup')) {
          obj['usePopup'] = _ApiClient["default"].convertToType(data['usePopup'], 'Boolean');
        }
      }
...
var _default = ConnectInstructions;
