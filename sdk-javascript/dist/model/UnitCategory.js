 ...
 * @version 0.0.1
 */
var UnitCategory = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>UnitCategory</code>.
   * @alias module:model/UnitCategory
   * @param name {String} Category name
   */
  function UnitCategory(name) {
    _classCallCheck(this, UnitCategory);
  ...
  _createClass(UnitCategory, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('standardUnitAbbreviatedName')) {
          obj['standardUnitAbbreviatedName'] = _ApiClient["default"].convertToType(data['standardUnitAbbreviatedName'], 'String');
        }
      }
