 ...
 * @version 0.0.1
 */
var TrackingReminderNotificationPost = /*#__PURE__*/function () {
  /**
   ...
   */
  function TrackingReminderNotificationPost(action, id) {
    _classCallCheck(this, TrackingReminderNotificationPost);
  ...
  _createClass(TrackingReminderNotificationPost, null, [{
    key: "initialize",
    value: function initialize(obj, action, id) {
      obj['action'] = action;
      obj['id'] = id;
    }
    /**
...
var _default = TrackingReminderNotificationPost;
