...
var _GetCorrelationsDataResponse = _interopRequireDefault(require("./GetCorrelationsDataResponse"));
 ...
 * @version 0.0.1
 */
var GetCorrelationsResponse = /*#__PURE__*/function () {
  /**
   ...
   */
  function GetCorrelationsResponse(description, summary) {
    _classCallCheck(this, GetCorrelationsResponse);
  ...
  _createClass(GetCorrelationsResponse, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('data')) {
          obj['data'] = _GetCorrelationsDataResponse["default"].constructFromObject(data['data']);
        }
...
var _default = GetCorrelationsResponse;
