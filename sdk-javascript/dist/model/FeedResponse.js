 ...
 * @version 0.0.1
 */
var FeedResponse = /*#__PURE__*/function () {
  /**
   ...
   */
  function FeedResponse(cards, description, summary) {
    _classCallCheck(this, FeedResponse);
  ...
  _createClass(FeedResponse, null, [{
    key: "initialize",
    value: function initialize(obj, cards, description, summary) {
      obj['cards'] = cards;
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('cards')) {
          obj['cards'] = _ApiClient["default"].convertToType(data['cards'], [_Card["default"]]);
        }
