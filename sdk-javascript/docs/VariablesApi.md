# CureDaoUnifiedHealthApi.VariablesApi
...
let apiInstance = new CureDaoUnifiedHealthApi.VariablesApi();
let opts = {
...
apiInstance.deleteUserTag(opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
let apiInstance = new CureDaoUnifiedHealthApi.VariablesApi();
apiInstance.deleteUserVariable((error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
let apiInstance = new CureDaoUnifiedHealthApi.VariablesApi();
apiInstance.getVariableCategories((error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
let apiInstance = new CureDaoUnifiedHealthApi.VariablesApi();
let body = new CureDaoUnifiedHealthApi.UserTag(); // UserTag | Contains the new user tag data
let opts = {
  'userId': 3.4 // Number | User's id
};
apiInstance.postUserTags(body, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> CommonResponse postUserVariables(variable, opts)
...
apiInstance.postUserVariables(variable, opts, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
> resetUserVariableSettings(userVariableDelete)
...
let apiInstance = new CureDaoUnifiedHealthApi.VariablesApi();
let userVariableDelete = new CureDaoUnifiedHealthApi.UserVariableDelete(); // UserVariableDelete | Id of the variable whose measurements should be deleted
apiInstance.resetUserVariableSettings(userVariableDelete, (error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully.');
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **userVariableDelete** | [**UserVariableDelete**](UserVariableDelete.md)| Id of the variable whose measurements should be deleted | 
