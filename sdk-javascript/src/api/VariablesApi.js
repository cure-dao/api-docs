...
export default class VariablesApi {
    ...
    */
     ...
     */
    getVariableCategories(callback) {
      let postBody = null;
      ...
      let contentTypes = [];
      let accepts = ['application/json'];
      let returnType = [VariableCategory];
      return this.apiClient.callApi(
     ...
     * data is of type: {@link module:model/CommonResponse}
     */
    postUserTags(body, opts, callback) {
      opts = opts || {};
      let postBody = body;
     ...
     * data is of type: {@link module:model/CommonResponse}
     */
    postUserVariables(variable, opts, callback) {
      opts = opts || {};
     ...
     */
    resetUserVariableSettings(userVariableDelete, callback) {
      let postBody = userVariableDelete;
      // verify the required parameter 'userVariableDelete' is set
