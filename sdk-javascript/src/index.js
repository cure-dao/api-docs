...
/**
* A_platform_for_participant_centered_research_and_personal_data_exploration.<br>
* The <code>index</code> module provides access to constructors for all the classes which comprise the public API.
* <p>
* An AMD (recommended!) or CommonJS application will generally do something equivalent to the following:
* <pre>
* var CureDaoUnifiedHealthApi = require('index'); // See note below*.
* var xxxSvc = new CureDaoUnifiedHealthApi.XxxApi(); // Allocate the API class we're going to use.
* var yyyModel = new CureDaoUnifiedHealthApi.Yyy(); // Construct a model instance.
...
* <pre>
* var xxxSvc = new CureDaoUnifiedHealthApi.XxxApi(); // Allocate the API class we're going to use.
* var yyy = new CureDaoUnifiedHealthApi.Yyy(); // Construct a model instance.
* yyyModel.someProperty = 'someValue';
* ...
* var zzz = xxxSvc.doSomething(yyyModel); // Invoke the service.
* ...
