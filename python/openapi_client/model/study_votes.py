...
class StudyVotes(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, average_vote, user_vote, *args, **kwargs):  # noqa: E501
        """StudyVotes - a model defined in OpenAPI
        ...
        self.average_vote = average_vote
