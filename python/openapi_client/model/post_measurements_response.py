...
def lazy_import():
    ...
    from openapi_client.model.post_measurements_data_response import PostMeasurementsDataResponse
    globals()['Card'] = Card
    globals()['ErrorResponse'] = ErrorResponse
    globals()['PostMeasurementsDataResponse'] = PostMeasurementsDataResponse


class PostMeasurementsResponse(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'data': (PostMeasurementsDataResponse,),  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, status, success, *args, **kwargs):  # noqa: E501
        """PostMeasurementsResponse - a model defined in OpenAPI

        Args:
            status (str): ex. OK or ERROR
        ...
        Keyword Args:
            ...
            data (PostMeasurementsDataResponse): [optional]  # noqa: E501
