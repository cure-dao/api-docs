...
class FeedResponse(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, cards, description, summary, *args, **kwargs):  # noqa: E501
        """FeedResponse - a model defined in OpenAPI

        Args:
            cards ([Card]):
            description (str): Tracking reminder notifications, messages, and study result cards that can be displayed in user feed or stream
            summary (str): Tracking reminder notifications, messages, and study results
