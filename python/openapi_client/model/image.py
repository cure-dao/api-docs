...
class Image(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, height, image_url, width, *args, **kwargs):  # noqa: E501
        """Image - a model defined in OpenAPI

        Args:
            height (str): Ex: 240
            image_url (str): Ex: https://www.filepicker.io/api/file/TjmeNWS5Q2SFmtJlUGLf
            width (str): Ex: 224
