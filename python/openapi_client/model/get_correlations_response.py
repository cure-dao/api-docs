...
def lazy_import():
    ...
    globals()['GetCorrelationsDataResponse'] = GetCorrelationsDataResponse


class GetCorrelationsResponse(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'data': (GetCorrelationsDataResponse,),  # noqa: E501
    ...
    def __init__(self, description, summary, *args, **kwargs):  # noqa: E501
        """GetCorrelationsResponse - a model defined in OpenAPI

        Args:
            description (str): Can be used as body of help info popup
        ...
        Keyword Args:
            ...
            data (GetCorrelationsDataResponse): [optional]  # noqa: E501
