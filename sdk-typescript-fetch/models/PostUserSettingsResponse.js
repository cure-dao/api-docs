...
exports.PostUserSettingsResponseToJSON = exports.PostUserSettingsResponseFromJSONTyped = exports.PostUserSettingsResponseFromJSON = void 0;
...
function PostUserSettingsResponseFromJSONTyped(json, ignoreDiscriminator) {
    ...
    return {
        'data': !(0, runtime_1.exists)(json, 'data') ? undefined : (0, _1.PostUserSettingsDataResponseFromJSON)(json['data']),
...
function PostUserSettingsResponseToJSON(value) {
    ...
    return {
        'data': (0, _1.PostUserSettingsDataResponseToJSON)(value.data),
...
//# sourceMappingURL=PostUserSettingsResponse.js.map
