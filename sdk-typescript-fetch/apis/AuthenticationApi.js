...
var AuthenticationApi = /** @class */ (function (_super) {
     ...
     */
    AuthenticationApi.prototype.getAccessTokenRaw = function (requestParameters) {
     ...
     * Get a user access token
     */
    AuthenticationApi.prototype.getAccessToken = function (requestParameters) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.getAccessTokenRaw(requestParameters)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
     ...
     */
    AuthenticationApi.prototype.getOauthAuthorizationCodeRaw = function (requestParameters) {
        return __awaiter(this, void 0, void 0, function () {
            var queryParameters, headerParameters, token, tokenString, response;
            return __generator(this, function (_a) {
                switch (_a.label) {
     ...
     * Request Authorization Code
     */
    AuthenticationApi.prototype.getOauthAuthorizationCode = function (requestParameters) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.getOauthAuthorizationCodeRaw(requestParameters)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
