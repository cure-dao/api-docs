...
exports.AppSettingsApi = void 0;
var runtime = require("../runtime");
var models_1 = require("../models");
/**
 *
 */
var AppSettingsApi = /** @class */ (function (_super) {
    __extends(AppSettingsApi, _super);
    function AppSettingsApi() {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        response = _a.sent();
                        return [2 /*return*/, new runtime.JSONApiResponse(response, function (jsonValue) { return (0, models_1.AppSettingsResponseFromJSON)(jsonValue); })];
                }
            });
        });
    };
    ...
    AppSettingsApi.prototype.getAppSettings = function (requestParameters) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.getAppSettingsRaw(requestParameters)];
                    case 1:
                        response = _a.sent();
