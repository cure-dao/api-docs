...
var AnalyticsApi = /** @class */ (function (_super) {
     ...
     * Get correlations
     */
    AnalyticsApi.prototype.getCorrelationsRaw = function (requestParameters) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        response = _a.sent();
                        return [2 /*return*/, new runtime.JSONApiResponse(response, function (jsonValue) { return (0, models_1.GetCorrelationsResponseFromJSON)(jsonValue); })];
                }
            });
        });
    };
     ...
     * Get correlations
     */
    AnalyticsApi.prototype.getCorrelations = function (requestParameters) {
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.getCorrelationsRaw(requestParameters)];
                    case 1:
                        response = _a.sent();
