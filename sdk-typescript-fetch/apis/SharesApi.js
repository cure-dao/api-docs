 ...
 *
 */
var SharesApi = /** @class */ (function (_super) {
    __extends(SharesApi, _super);
    function SharesApi() {
     ...
     * Delete share
     */
    SharesApi.prototype.deleteShareRaw = function (requestParameters) {
     ...
     * Delete share
     */
    SharesApi.prototype.deleteShare = function (requestParameters) {
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.deleteShareRaw(requestParameters)];
                    case 1:
                        response = _a.sent();
     ...
     */
    SharesApi.prototype.getSharesRaw = function (requestParameters) {
        return __awaiter(this, void 0, void 0, function () {
            var queryParameters, headerParameters, token, tokenString, response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        response = _a.sent();
                        return [2 /*return*/, new runtime.JSONApiResponse(response, function (jsonValue) { return (0, models_1.GetSharesResponseFromJSON)(jsonValue); })];
                }
            });
        });
    };
     ...
     * Get Authorized Apps, Studies, and Individuals
     */
    SharesApi.prototype.getShares = function (requestParameters) {
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.getSharesRaw(requestParameters)];
                    case 1:
                        response = _a.sent();
                        return [4 /*yield*/, response.value()];
                    case 2: return [2 /*return*/, _a.sent()];
     ...
     * Delete share
     */
    SharesApi.prototype.inviteShareRaw = function (requestParameters) {
        return __awaiter(this, void 0, void 0, function () {
            var queryParameters, headerParameters, token, tokenString, response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.request({
                                ...
                                headers: headerParameters,
                                query: queryParameters,
                                body: (0, models_1.ShareInvitationBodyToJSON)(requestParameters.body),
                            })];
                    case 1:
                        response = _a.sent();
                        return [2 /*return*/, new runtime.JSONApiResponse(response, function (jsonValue) { return (0, models_1.UserFromJSON)(jsonValue); })];
     ...
     * Delete share
     */
    SharesApi.prototype.inviteShare = function (requestParameters) {
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.inviteShareRaw(requestParameters)];
                    case 1:
                        response = _a.sent();
                        return [4 /*yield*/, response.value()];
                    case 2: return [2 /*return*/, _a.sent()];
